...
type Props ={};
    ...
    return (
     ...
     <View style={styles.container}>
          ...
          <TouchableOpacity
              ...
              <View style={styles.title}><Text style={styles.titleText}> Discover</Text></View>
 ...
 <View style={styles.testimonyContainer}>
    ...
    <TouchableOpacity
     ...
     <View style={styles.saintContainer}>
        <View style={styles.saintTitle}>
          <Text style={styles.saintTitleText}>Saint of the  Day</Text>
        </View>
        {
         saintData &&  saintData .length > 0 &&  saintData.map(val => {
          return (
        <View style={styles.saintCard} key={val.id}>
            <View style={styles.saintImgContainer}>
                <Image source={val.saintImg}   style={styles.saintImg} />
                <View style={styles.saintOverlay} />
             </View>
        <View style={styles.saintCaption1}>
             <View><Text style={styles.saintName}>{val.saintName}</Text></View>
             <View><Text style={styles.saintNameB}>{val.saintShortBio} </Text></View>
        </View>
        <View style={styles.saintBio}>
        <Text style={styles.saintBioText}>
        {val.saintBioInf}
        </Text>
        </View>

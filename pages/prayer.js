...
import {prayData} from '../utils/prayer/prayerCardData';
    ...
    return (
     <View style={styles.container}>
          ...
          <TouchableOpacity
              ...
              <View style={styles.title}><Text style={styles.titleText}>Prayers</Text></View>
     ...
     {
      prayData && prayData.length > 0 && prayData.map(val => {
       return (
        <TouchableOpacity
